 ...
 * and javax.sound.sampled.AudioSystem.
 *
...
public final class JDK13Services {
    ...
    public static List<?> getProviders(final Class<?> serviceClass) {
        ...
        if (!MixerProvider.class.equals(serviceClass)
            ...
            List<Object> p = new ArrayList<>(7);
            final Iterator<?> ps = ServiceLoader.load(serviceClass).iterator();
    ...
    */
    ...
    private static void loadPropertiesImpl(Properties properties, String filename) {
        if(Printer.trace) Printer.trace(">> JDK13Services: loadPropertiesImpl()");
        ...
        if(Printer.trace) Printer.trace("<< JDK13Services: loadPropertiesImpl() completed");
    }
