...
public final class SoftSynthesizer implements AudioSynthesizer,
    ...
    public Soundbank getDefaultSoundbank() {
        synchronized (SoftSynthesizer.class) {
            ...
            List<Callable<InputStream>> actions =
                new ArrayList<Callable<InputStream>>();

            actions.add(new Callable<InputStream>() {
            ...
            for (Callable<InputStream> action : actions) {
                try {
                    InputStream is = action.call();
                    if(is == null) continue;
                    Soundbank sbk;
                    try {
            ...
            if (defaultSoundBank != null) {
                ...
                try {
                    ...
                    out = new FileOutputStream(emg_soundbank_file);
